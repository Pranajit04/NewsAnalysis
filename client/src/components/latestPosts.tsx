...
const latestPosts = () => {
  ...
  return (
    <>
      {newsData?.length > 0 ? (
        <div className="bg-[#0f141f] text-[var(--retro-ink)] mt-6 px-4 py-6 rounded-2xl border-4 border-[#ffb86c] shadow-[0_12px_0_#070a12]">
          <div className="flex flex-wrap justify-center items-center gap-4">
            <div className="flex justify-center items-center text-2xl md:text-3xl font-bold m-2 retro-heading text-[var(--retro-cyan)] drop-shadow-[0_0_12px_rgba(55,240,232,0.7)]">
              Latest Articles In
            </div>
            <div className="relative">
              <Dropdown>
                <DropdownTrigger>
                  <Button variant="bordered" className="capitalize border-2 border-[#ffb86c] bg-[#1b2234] text-[var(--retro-ink)] shadow-[0_6px_0_#070a12]">
                    <div className="flex uppercase justify-center items-center text-2xl font-bold -ml-2">
                      {selectedValue}
